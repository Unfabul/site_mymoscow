...
?>
    ...
    <div class="trips">
        <h2 class="title-h2">Выберите тур</h2>
        <div class="trips-blocks">
            <div class="trips-blocks-block">
                <div class="trips-blocks-block-img trip-img1"></div>
                <div class="trips-blocks-block-text">
                    <div class="trips-text">
                        ...
                        <p class="trips-price">2 часа - 2300 руб.</p>
                        <div class="trips-button">Забронировать</div>
                    </div>
                </div>
            </div>
            <div class="trips-blocks-block reverse">
                <div class="trips-blocks-block-text">
                    <div class="trips-text text-right">
                        ...
                        <p class="trips-price">3 часа - 2900 руб.</p>
                        <div class="trips-button">Забронировать</div>
                    </div>
                </div>
                <div class="trips-blocks-block-img trip-img2"></div>
            </div>
            <div class="trips-blocks-block">
                <div class="trips-blocks-block-img trip-img3"></div>
                <div class="trips-blocks-block-text">
                    <div class="trips-text">
                        ...
                        <p class="trips-price">1,5 часа - 1900 руб.</p>
                        <div class="trips-button">Забронировать</div>
                    </div>
                </div>
            </div>
            <div class="trips-blocks-block reverse">
                <div class="trips-blocks-block-text">
                    <div class="trips-text text-right">
                        ...
                        <p class="trips-price">1 час - 1500 руб.</p>
                        <div class="trips-button">Забронировать</div>
                    </div>
                </div>
                <div class="trips-blocks-block-img trip-img4"></div>
            </div>
        </div>
    </div>

    <div class="trips-popup">
        <div class="trips-popup-content">
            ...
            <div class="trips-popup-close-button">
                <div class="trips-popup-close-button-arrows">
                    <div class="trips-popup-close-button-arrows-arrow-down"></div>
                    <div class="trips-popup-close-button-arrows-arrow-up"></div>
                </div>
            </div>
        </div>
    </div>
